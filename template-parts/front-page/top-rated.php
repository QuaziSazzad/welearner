        ...
        <section class="tranding-area pd-top-60">
          <div class="container">
              <div class="section-title">
                  <div class="row">
                    <?php if( !empty( get_theme_mod( 'tranding_top_rated_title' ) ) ) : ?>
                        <div class="col-md-9 align-self-center">
                            <h2><?php echo esc_html( get_theme_mod( 'tranding_top_rated_title' ) ); ?></h2>
                        </div>
                    <?php endif; ?>
                     <?php if( !empty( get_theme_mod( 'top_rated_show_all_url' ) ) ) : ?>
                      <div class="col-md-3 text-md-right">
                          <a class="btn btn-base-border" href="<?php echo esc_url( get_theme_mod( 'top_rated_show_all_url' ) ); ?>"><?php echo esc_html__( 'Show All', 'welearner' ); ?></a>
                      </div>
                      <?php endif; ?>
                  </div>
              </div>
